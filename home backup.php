				...
				<li class="dropdown profile_details_drop">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i><span class="caret"></span></a>
						<div class="w3ls_vegetables">
							<?php "Hello ";echo '<font color="white">'.$name.'</font>'; ?>
						</div> 
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					<li><a href="events.html">Review</a><i>||</i></li>
					<li><a href="about.html">About Us</a><i>||</i></li>
					<li><a href="about.html">Ordered Item</a></li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left1">
...
<!-- banner -->
	<div class="banner">
		<div class="w3l_banner_nav_middle">
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				</br><u><h2>Food Items</h2></u>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/21.jpg" alt=" " class="img-responsive" /></a>
											<p>Singara</p>
											<h4>5 taka<span>8 taka</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													
													<input type="hidden" name="food_code" value="12" />
											

													<input type="text" id="quantity" name="quantity" placeholder="     Enter Quantity" size="15">

													<input type="submit" class="btn" value="Procced" name="buy">
												</fieldset>
											</form>
										</div>
									</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>Somucha</p>
											<h4>10 taka <span>15 taka</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>Burger</p>
											<h4>45 taka<span>50 taka</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/21.jpg" alt=" " class="img-responsive" /></a>
											<p>Sandwitch</p>
											<h4>25 taka <span>35 taka</span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
