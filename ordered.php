...
if(isset($_GET['search'])){
     ...
     $sql    = "SELECT food_name,order_payment.quantity,amount,timee,order_status FROM order_payment,food_item WHERE 
      (order_payment.food_code=food_item.food_code AND food_name LIKE '%$searchKey%' AND email='$email')";
}else
    $sql    = "SELECT food_name,order_payment.quantity,amount,timee,order_status FROM order_payment,food_item WHERE 
      (order_payment.food_code=food_item.food_code AND email='$email')";
